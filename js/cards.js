...
export const PREMIUM_CARD_CATALOG = [
  ...
  {id:'amex_hilton_honors_nofee',issuer:'American Express',name:'Hilton Honors (No Annual Fee)',fee:0,supported:false},
  ...
  {id:'chase_freedom_unlimited',issuer:'Chase',name:'Chase Freedom Unlimited',fee:0,supported:false},
  {id:'chase_ink_cash',issuer:'Chase',name:'Chase Ink Business Cash',fee:0,supported:false},
  ...
  {id:'citi_costco_anywhere',issuer:'Citi',name:'Costco Anywhere Visa',fee:0,supported:false},
  ...
  {id:'wf_active_cash',issuer:'Wells Fargo',name:'Active Cash',fee:0,supported:false},
  // Bank of America
